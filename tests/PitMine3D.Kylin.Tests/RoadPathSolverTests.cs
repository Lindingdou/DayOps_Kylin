...
/// <summary>
/// 约束感知运输寻径(DijkstraPathSolver)已知值回归 —— 逐字移植原 Tests.RoadLib/PathSolverTests
/// (等价性由构造保证)。核心场景:坑底→地表两条路——折返路 A(A1..A4, 每段 ≤8%) vs 直连路 B(13.3%, 超 10% 限坡)。
/// </summary>
public class RoadPathSolverTests
{

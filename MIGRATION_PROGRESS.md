...
**修改（9）**：复制✅ 移动✅ 旋转✅ 删除✅ 分解✅ 偏移✅(线/圆/矩/多段线/圆弧) 打断✅(线/多段线/圆弧) 夹点✅ 修剪✅ 延伸✅(边界任意实体；目标 线+多段线末端) | (圆弧目标修剪待做)
...
**下一步（仅对齐原程序的增量增强，不新增原版没有的命令）**：圆 圆-圆/线-圆相切 → 圆弧目标修剪 → 选项设置对话框 → 文字/渲染配置(需 Skia/内核，记录)。

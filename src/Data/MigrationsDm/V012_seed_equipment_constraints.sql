-- 由 build/sqlite2dm.py 从 V012_seed_equipment_constraints.sql 自动生成, 请勿手改。
...
REPLACE INTO equipment_constraint (param_id, equipment_model, constraint_type, limit_value, consequence, priority, description)
VALUES

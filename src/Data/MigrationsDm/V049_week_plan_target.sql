-- 由 build/sqlite2dm.py 从 V049_week_plan_target.sql 自动生成, 请勿手改。
...
CREATE TABLE week_plan_target (
    monday            VARCHAR(255) NOT NULL,                   -- 该周周一 yyyy-MM-dd(周口径的唯一键)
    target_coal_wan_t DOUBLE NOT NULL DEFAULT 0,         -- 本周采出目标 万t(与 monthly_plan 同单位)
    target_strip_wan_m3 DOUBLE NOT NULL DEFAULT 0,       -- 本周剥离目标 万m³
    "source"            VARCHAR(255) NOT NULL DEFAULT '人工下达', -- 人工下达 / 按月摊算后确认 / 其它
    note              VARCHAR(2000),

-- 由 build/sqlite2dm.py 从 V004_seed_process_geometry.sql 自动生成, 请勿手改。
...
-- ─── 平盘维表 ───────────────────────────────────────────────────────────────
REPLACE INTO mine_location (location_code, name, elevation_m, team, is_active) VALUES

...
-- ─── 平盘维表 ───────────────────────────────────────────────────────────────
INSERT OR REPLACE INTO mine_location (location_code, name, elevation_m, team, is_active) VALUES
...
-- ─── 工作面(5 个活跃)──────────────────────────────────────────────────────
INSERT OR REPLACE INTO working_face
...
-- ─── 排土场(2 个)─────────────────────────────────────────────────────────
INSERT OR REPLACE INTO dump_site
...
-- ─── 边坡设计(4 帮)───────────────────────────────────────────────────────
INSERT OR REPLACE INTO slope_design
...
-- ─── 道路网络(6 段)───────────────────────────────────────────────────────
INSERT OR REPLACE INTO haul_road

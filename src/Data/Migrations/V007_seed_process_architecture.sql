...
-- ─── 8 个工艺系统 ───────────────────────────────────────────────────────────
INSERT OR REPLACE INTO process_system (system_id, code, name, category, description, display_order) VALUES
...
-- ─── 28 个工艺环节 ─────────────────────────────────────────────────────────
INSERT OR REPLACE INTO process_phase (phase_id, system_id, code, name, sequence_order, typical_equipment_category, description) VALUES
    -- 穿爆系统
...
-- ─── 60+ 参数定义 ─────────────────────────────────────────────────────────
-- 穿爆 / 钻孔
INSERT OR REPLACE INTO parameter_definition

...
CREATE TABLE IF NOT EXISTS week_plan_target (
    ...
    target_coal_wan_t REAL NOT NULL DEFAULT 0,         -- 本周采出目标 万t(与 monthly_plan 同单位)
    target_strip_wan_m3 REAL NOT NULL DEFAULT 0,       -- 本周剥离目标 万m³
...
CREATE INDEX IF NOT EXISTS idx_week_target_monday ON week_plan_target(monday);

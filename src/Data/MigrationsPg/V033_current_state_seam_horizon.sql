-- 由 build/sqlite2pg.py 从 V033_current_state_seam_horizon.sql 自动生成, 请勿手改。
...
ALTER TABLE current_state_point ADD COLUMN seam_code TEXT;   -- 煤层编号(4/7-1/9/11/...)
ALTER TABLE current_state_point ADD COLUMN horizon TEXT;   -- '顶板' / '底板'

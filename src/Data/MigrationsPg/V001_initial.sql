-- 由 build/sqlite2pg.py 从 V001_initial.sql 自动生成, 请勿手改。
...
CREATE TABLE IF NOT EXISTS equipment_model (
    ...
    working_weight_t        DOUBLE PRECISION,
    power_kw                DOUBLE PRECISION,
    bucket_m3               DOUBLE PRECISION,
    load_t                  DOUBLE PRECISION,
    dimensions_lwh          TEXT,
    drill_diameter_mm       DOUBLE PRECISION,
    tire_spec               TEXT,
    std_daily_cap_wan_m3    DOUBLE PRECISION
);
...
CREATE TABLE IF NOT EXISTS equipment_kpi_monthly (
    ...
    actual_run_rate           DOUBLE PRECISION NOT NULL DEFAULT 0,
    utilization_rate          DOUBLE PRECISION NOT NULL DEFAULT 0,
    internal_fault_rate_pct   DOUBLE PRECISION NOT NULL DEFAULT 0,
    external_fault_rate_pct   DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS blast_event (
    ...
    unit_consumption_kg_m3      DOUBLE PRECISION,
...
CREATE TABLE IF NOT EXISTS daily_mine_summary (
    ...
    big_belt_coal_t         DOUBLE PRECISION NOT NULL DEFAULT 0,
    small_belt_coal_t       DOUBLE PRECISION NOT NULL DEFAULT 0,
    longhua_coal_t          DOUBLE PRECISION NOT NULL DEFAULT 0,
    truck_coal_export_t     DOUBLE PRECISION NOT NULL DEFAULT 0,
    winnowed_coal_t         DOUBLE PRECISION NOT NULL DEFAULT 0,
    big_truck_pile_coal_t   DOUBLE PRECISION NOT NULL DEFAULT 0,
    stripping_total_m3      DOUBLE PRECISION NOT NULL DEFAULT 0,
    silo_1_t                DOUBLE PRECISION NOT NULL DEFAULT 0,
    silo_2_t                DOUBLE PRECISION NOT NULL DEFAULT 0,
    silo_3_t                DOUBLE PRECISION NOT NULL DEFAULT 0
);
...
CREATE TABLE IF NOT EXISTS monthly_plan (
    ...
    ratio_strip_coal              DOUBLE PRECISION NOT NULL DEFAULT 0,
    avg_distance_km               DOUBLE PRECISION NOT NULL DEFAULT 0,
    avg_height_m                  DOUBLE PRECISION NOT NULL DEFAULT 0,
    team1_distance_km             DOUBLE PRECISION NOT NULL DEFAULT 0,
    team2_distance_km             DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS workforce_monthly (
    ...
    coal_workdays                DOUBLE PRECISION NOT NULL DEFAULT 0,
    coal_output_t                DOUBLE PRECISION NOT NULL DEFAULT 0,
    overall_eff_t_per_workday    DOUBLE PRECISION NOT NULL DEFAULT 0,
    coal_eff_t_per_workday       DOUBLE PRECISION NOT NULL DEFAULT 0,
    overall_eff_t_per_person     DOUBLE PRECISION NOT NULL DEFAULT 0,
    coal_eff_t_per_person        DOUBLE PRECISION NOT NULL DEFAULT 0,
    PRIMARY KEY (year, month)
);

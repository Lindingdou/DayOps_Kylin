-- 由 build/sqlite2pg.py 从 V037_face_source_xyz.sql 自动生成, 请勿手改。
...
ALTER TABLE working_face_routing ADD COLUMN source_x DOUBLE PRECISION NOT NULL DEFAULT 0;  -- 源代表点 X(m);x、y 均为 0 = 未录坐标
ALTER TABLE working_face_routing ADD COLUMN source_y DOUBLE PRECISION NOT NULL DEFAULT 0;  -- 源代表点 Y(m)
ALTER TABLE working_face_routing ADD COLUMN source_z DOUBLE PRECISION NOT NULL DEFAULT 0;  -- 源代表点 Z 标高(m);Z=0 是合法标高,不参与"有没有坐标"的判定

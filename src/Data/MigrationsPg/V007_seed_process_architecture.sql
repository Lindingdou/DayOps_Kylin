-- 由 build/sqlite2pg.py 从 V007_seed_process_architecture.sql 自动生成, 请勿手改。
...
-- ─── 8 个工艺系统 ───────────────────────────────────────────────────────────
INSERT INTO process_system (system_id, code, name, category, description, display_order) VALUES
    ...
    (8, 'safety',    '安全环保系统',   'safety',    '振动 / 粉尘 / 噪声监测 + 安全规程',                  80) ON DUPLICATE KEY UPDATE name = VALUES(name), category = VALUES(category), description = VALUES(description), display_order = VALUES(display_order);
...
INSERT INTO process_phase (phase_id, system_id, code, name, sequence_order, typical_equipment_category, description) VALUES
    ...
    (804, 8, 'safety_rules',     '安全规程',        4, NULL,        '操作规程与隐患排查') ON DUPLICATE KEY UPDATE name = VALUES(name), sequence_order = VALUES(sequence_order), typical_equipment_category = VALUES(typical_equipment_category), description = VALUES(description);
...
INSERT INTO parameter_definition (param_id, phase_id, code, name, unit, value_type,
    ...
    (1007, 101, 'hole_count',            '单炮孔数',     '个',     'numeric',  50, 300, 174,  20, 500, 0, NULL, 'blast_event', 'hole_count',    '单次爆破炮孔总数',   7) ON DUPLICATE KEY UPDATE phase_id = VALUES(phase_id), name = VALUES(name), unit = VALUES(unit), value_type = VALUES(value_type), standard_min = VALUES(standard_min), standard_max = VALUES(standard_max), standard_default = VALUES(standard_default), alarm_low = VALUES(alarm_low), alarm_high = VALUES(alarm_high), is_required = VALUES(is_required), calc_formula = VALUES(calc_formula), source_table = VALUES(source_table), source_column = VALUES(source_column), description = VALUES(description), display_order = VALUES(display_order);
...
INSERT INTO parameter_definition (param_id, phase_id, code, name, unit, value_type,
    ...
    (1104, 102, 'explosive_type',        '炸药类型',     '',       'text',     NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL,           NULL,            '乳化/铵油/电子',     4) ON DUPLICATE KEY UPDATE phase_id = VALUES(phase_id), name = VALUES(name), unit = VALUES(unit), value_type = VALUES(value_type), standard_min = VALUES(standard_min), standard_max = VALUES(standard_max), standard_default = VALUES(standard_default), alarm_low = VALUES(alarm_low), alarm_high = VALUES(alarm_high), is_required = VALUES(is_required), calc_formula = VALUES(calc_formula), source_table = VALUES(source_table), source_column = VALUES(source_column), description = VALUES(description), display_order = VALUES(display_order);
...
INSERT INTO parameter_definition (param_id, phase_id, code, name, unit, value_type,
    ...
    (1202, 103, 'delay_ms',               '雷管延期',     'ms',     'numeric',  25, 100,  50,  10, 200, 0, NULL, NULL, NULL, '毫秒延期',                 2) ON DUPLICATE KEY UPDATE phase_id = VALUES(phase_id), name = VALUES(name), unit = VALUES(unit), value_type = VALUES(value_type), standard_min = VALUES(standard_min), standard_max = VALUES(standard_max), standard_default = VALUES(standard_default), alarm_low = VALUES(alarm_low), alarm_high = VALUES(alarm_high), is_required = VALUES(is_required), calc_formula = VALUES(calc_formula), source_table = VALUES(source_table), source_column = VALUES(source_column), description = VALUES(description), display_order = VALUES(display_order);
...
INSERT INTO parameter_definition (param_id, phase_id, code, name, unit, value_type,
    ...
    (1304, 104, 'toe_rate_pct',          '根底率',       '%',      'numeric',  0,   3,    2,   0,   5, 1, NULL, NULL, NULL, '根底占比',                4) ON DUPLICATE KEY UPDATE phase_id = VALUES(phase_id), name = VALUES(name), unit = VALUES(unit), value_type = VALUES(value_type), standard_min = VALUES(standard_min), standard_max = VALUES(standard_max), standard_default = VALUES(standard_default), alarm_low = VALUES(alarm_low), alarm_high = VALUES(alarm_high), is_required = VALUES(is_required), calc_formula = VALUES(calc_formula), source_table = VALUES(source_table), source_column = VALUES(source_column), description = VALUES(description), display_order = VALUES(display_order);
...
INSERT INTO parameter_definition (param_id, phase_id, code, name, unit, value_type,
    ...
    (2006, 201, 'face_length',           '工作面长度',   'm',      'numeric', 150,300,  220, 120, 400, 0, NULL, 'working_face', 'face_length_m',          '工作面延展长度', 6) ON DUPLICATE KEY UPDATE phase_id = VALUES(phase_id), name = VALUES(name), unit = VALUES(unit), value_type = VALUES(value_type), standard_min = VALUES(standard_min), standard_max = VALUES(standard_max), standard_default = VALUES(standard_default), alarm_low = VALUES(alarm_low), alarm_high = VALUES(alarm_high), is_required = VALUES(is_required), calc_formula = VALUES(calc_formula), source_table = VALUES(source_table), source_column = VALUES(source_column), description = VALUES(description), display_order = VALUES(display_order);
...
INSERT INTO parameter_definition (param_id, phase_id, code, name, unit, value_type,
    ...
    (3004, 302, 'cycle_time_min',        '单循环分钟',   'min',    'numeric',  15,  30,   20,  10,   45, 0, NULL, 'dispatch_rule', 'cycle_time_min', '装-运-卸-返循环时长', 4) ON DUPLICATE KEY UPDATE phase_id = VALUES(phase_id), name = VALUES(name), unit = VALUES(unit), value_type = VALUES(value_type), standard_min = VALUES(standard_min), standard_max = VALUES(standard_max), standard_default = VALUES(standard_default), alarm_low = VALUES(alarm_low), alarm_high = VALUES(alarm_high), is_required = VALUES(is_required), calc_formula = VALUES(calc_formula), source_table = VALUES(source_table), source_column = VALUES(source_column), description = VALUES(description), display_order = VALUES(display_order);
...
INSERT INTO parameter_definition (param_id, phase_id, code, name, unit, value_type,
    ...
    (4004, 402, 'dump_fill_rate',        '充填率',       '',       'numeric',   0,   1, 0.6,   0,    1, 0, NULL, NULL, NULL, '已堆/设计',                4) ON DUPLICATE KEY UPDATE phase_id = VALUES(phase_id), name = VALUES(name), unit = VALUES(unit), value_type = VALUES(value_type), standard_min = VALUES(standard_min), standard_max = VALUES(standard_max), standard_default = VALUES(standard_default), alarm_low = VALUES(alarm_low), alarm_high = VALUES(alarm_high), is_required = VALUES(is_required), calc_formula = VALUES(calc_formula), source_table = VALUES(source_table), source_column = VALUES(source_column), description = VALUES(description), display_order = VALUES(display_order);
...
INSERT INTO parameter_definition (param_id, phase_id, code, name, unit, value_type,
    ...
    (5002, 501, 'safety_factor_F',       '安全系数 F',   '',       'numeric',  1.30, 2.0, 1.35, 1.0, 3.0, 1, NULL, 'slope_design', 'safety_factor',           'F ≥ 1.30 安全', 2) ON DUPLICATE KEY UPDATE phase_id = VALUES(phase_id), name = VALUES(name), unit = VALUES(unit), value_type = VALUES(value_type), standard_min = VALUES(standard_min), standard_max = VALUES(standard_max), standard_default = VALUES(standard_default), alarm_low = VALUES(alarm_low), alarm_high = VALUES(alarm_high), is_required = VALUES(is_required), calc_formula = VALUES(calc_formula), source_table = VALUES(source_table), source_column = VALUES(source_column), description = VALUES(description), display_order = VALUES(display_order);
...
INSERT INTO parameter_definition (param_id, phase_id, code, name, unit, value_type,
    ...
    (5102, 502, 'max_depth',             '最大开采深度', 'm',      'numeric', 200, 400,  300, 100,  500, 0, NULL, 'slope_design', 'max_depth_m',           '矿坑最大深度',   2) ON DUPLICATE KEY UPDATE phase_id = VALUES(phase_id), name = VALUES(name), unit = VALUES(unit), value_type = VALUES(value_type), standard_min = VALUES(standard_min), standard_max = VALUES(standard_max), standard_default = VALUES(standard_default), alarm_low = VALUES(alarm_low), alarm_high = VALUES(alarm_high), is_required = VALUES(is_required), calc_formula = VALUES(calc_formula), source_table = VALUES(source_table), source_column = VALUES(source_column), description = VALUES(description), display_order = VALUES(display_order);
...
INSERT INTO parameter_definition (param_id, phase_id, code, name, unit, value_type,
    ...
    (7004, 702, 'outsource_unit_price',  '外委单价',     '元/m³',  'numeric',   8,  18,   12,   5,   25, 0, NULL, NULL, NULL, '外委剥离单价',     4) ON DUPLICATE KEY UPDATE phase_id = VALUES(phase_id), name = VALUES(name), unit = VALUES(unit), value_type = VALUES(value_type), standard_min = VALUES(standard_min), standard_max = VALUES(standard_max), standard_default = VALUES(standard_default), alarm_low = VALUES(alarm_low), alarm_high = VALUES(alarm_high), is_required = VALUES(is_required), calc_formula = VALUES(calc_formula), source_table = VALUES(source_table), source_column = VALUES(source_column), description = VALUES(description), display_order = VALUES(display_order);
...
INSERT INTO parameter_definition (param_id, phase_id, code, name, unit, value_type,
    ...
    (8002, 801, 'flying_rock_distance',  '飞石距离',     'm',      'numeric',   0, 200,  100,   0,  500, 0, NULL, NULL, NULL, '爆破飞石最远距',    2) ON DUPLICATE KEY UPDATE phase_id = VALUES(phase_id), name = VALUES(name), unit = VALUES(unit), value_type = VALUES(value_type), standard_min = VALUES(standard_min), standard_max = VALUES(standard_max), standard_default = VALUES(standard_default), alarm_low = VALUES(alarm_low), alarm_high = VALUES(alarm_high), is_required = VALUES(is_required), calc_formula = VALUES(calc_formula), source_table = VALUES(source_table), source_column = VALUES(source_column), description = VALUES(description), display_order = VALUES(display_order);

-- 安全 / 粉尘监测
INSERT INTO parameter_definition (param_id, phase_id, code, name, unit, value_type,
     standard_min, standard_max, standard_default, alarm_low, alarm_high, is_required,
     calc_formula, source_table, source_column, description, display_order) VALUES
    (8101, 802, 'dust_concentration',    '粉尘浓度',     'mg/m³',  'numeric',   0,  10,    4,   0,   20, 1, NULL, NULL, NULL, '工作区呼吸粉尘',   1) ON DUPLICATE KEY UPDATE phase_id = VALUES(phase_id), name = VALUES(name), unit = VALUES(unit), value_type = VALUES(value_type), standard_min = VALUES(standard_min), standard_max = VALUES(standard_max), standard_default = VALUES(standard_default), alarm_low = VALUES(alarm_low), alarm_high = VALUES(alarm_high), is_required = VALUES(is_required), calc_formula = VALUES(calc_formula), source_table = VALUES(source_table), source_column = VALUES(source_column), description = VALUES(description), display_order = VALUES(display_order);
